<!--
    https://db.cse.ce.nihon-u.ac.jp/~u20206076/report/menu/hamburger.php
-->
<?php
...
<html lang="ja">
    ...
    <body style="background-color: #36393F; color: #FFF;">
        ...
        <?php
            if(isset($_GET['id'])){
                $id = $_GET['id'];
                print "<img src='https://2.bp.blogspot.com/-63vQtYUKJBY/UgSMCmG66LI/AAAAAAAAW6w/-VMth7DVjcY/s800/food_hamburger.png'/>";
                $dbconn=pg_connect("dbname=u20206076 user=u20206076");
                if(!$dbconn)
                {
                    exit("DB Connection Failed!");
                ...
                {
                    $row=pg_fetch_row($query, $i);
                    print "<a href='https://db.cse.ce.nihon-u.ac.jp/~u20206076/report/menu/hamburger.php?id={$row[0]}'>";
                    print "<img src='https://2.bp.blogspot.com/-63vQtYUKJBY/UgSMCmG66LI/AAAAAAAAW6w/-VMth7DVjcY/s375/food_hamburger.png'/><br/>";
                    for($j=0; $j<count($row); $j++) 
                    {
                        if ($j==1)
                        {
