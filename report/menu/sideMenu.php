<!--
    https://db.cse.ce.nihon-u.ac.jp/~u20206076/report/menu/sideMenu.php
-->
<?php
...
<html lang="ja">
    ...
    <body style="background-color: #36393F; color: #FFF;">
        ...
        <?php
            if(isset($_GET['id'])){
                $id = $_GET['id'];
                print "<img src='https://1.bp.blogspot.com/-bOCAVcH_uwE/WGnPRCHZedI/AAAAAAABA2s/FsT_o7eTJjAvyDOY5YCmrtvFSJNi_jEFwCLcB/s600/fastfood_potato_onion.png'/>";
                $dbconn=pg_connect("dbname=u20206076 user=u20206076");
                if(!$dbconn)
                {
                    exit("DB Connection Failed!");
                ...
                {
                    $row=pg_fetch_row($query, $i);
                    print "<a href='https://db.cse.ce.nihon-u.ac.jp/~u20206076/report/menu/sideMenu.php?id={$row[0]}'>";
                    print "<img src='https://1.bp.blogspot.com/-bOCAVcH_uwE/WGnPRCHZedI/AAAAAAABA2s/FsT_o7eTJjAvyDOY5YCmrtvFSJNi_jEFwCLcB/s600/fastfood_potato_onion.png'/><br/>";
                    for($j=0; $j<count($row); $j++) 
                    {
                        if ($j==1)
                        {
